-- Increase ivfflat.probes from 20 to 60 so the vector index searches 3x more clusters.
-- With ~9000 films having platform_ids, probes=20 was returning ~32 candidates after filtering.
-- probes=60 should yield 100-200 platform candidates, giving movie-match better material.
-- SQL latency impact: ~296ms → ~500ms — acceptable vs Gemini's 7-10s.
