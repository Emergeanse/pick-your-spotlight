-- Correction du filtre excluded_genres dans count_movie_candidates.
-- Bug : me.genres[1] = ANY(excluded_genres) ne vérifie que le premier genre.
-- Fix : me.genres && excluded_genres (cohérent avec match_movies_for_recommendation).
