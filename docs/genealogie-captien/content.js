...
const CHAPTERS = [
  ...
  },
  {
    ...
    narrative: [
      ...
      `On se déplace. Pas loin — une vingtaine de kilomètres à vol d'oiseau, une journée de charrette — mais assez pour changer de paroisse, de curé, de registre. Bambiderstroff, village du canton de Boulay, accueille <a class="person-link" href="personne.html#jean-schneider-1667">Jean (Haman) SCHNEIDER</a>, laboureur — né en 1667, on ne sait pas où au juste, mais mort le 13 décembre 1727 à Bambiderstroff, ça au moins c'est sûr — qui s'y marie le 28 novembre 1684 avec <a class="person-link" href="personne.html#marie-jungers">Marie JUNGERS</a>. Il a dix-sept ans. La terre, ici, c'est la frontière : le Luxembourg est à portée de cloche, la Sarre aussi, et les familles se marient entre voisins parce qu'on n'a ni le temps ni l'argent d'aller plus loin. (Étrangeté de l'histoire, tiens : Bambiderstroff… ça résonne, à une syllabe près, avec Bidestroff, cet autre village mosellan où vivait la lignée BILLIEUX à la même époque. Aucun lien de sang entre les deux, sans doute — juste ce même suffixe « -stroff », légué par des siècles de peuplement germanique en Moselle, qui fait se ressembler des lieux qui n'ont jamais eu affaire l'un à l'autre.)`,
      ...
      `Et de ce couple naît <a class="person-link" href="personne.html#angelique-schneider-1695">Angélique</a>, le 29 avril 1695 — la charnière. Elle épousera <a class="person-link" href="personne.html#nicolas-captien-1695">Nicolas CAPTIEN</a>, né la même année, quelque part qu'on n'a pas encore localisé. Bambiderstroff, c'est le dernier village mosellan de la souche SCHNEIDER. Après Angélique, ce sera Mondorf. La frontière qu'on franchit, ce n'est pas celle des cartes — c'est celle d'un mariage, d'un acte, d'un prêtre qui inscrit deux noms côte à côte.`
    ],
    cards: [
      {
        type: 'histoire',
  ...
  },
  {
    ...
    narrative: [
      `Mondorf-les-Bains. Aujourd'hui station thermale, casinos, eaux minérales — à l'époque de <a class="person-link" href="personne.html#christian-captien-1718">Christian CAPTIEN</a>, né le 19 janvier 1718, c'était un village agricole du canton de Remich, dans le Grevenmacher luxembourgeois. La lignée CAPTIEN s'y fixe. Et elle y reste. Un siècle, et davantage — quatre générations qui naissent, se marient, meurent au même endroit, sur les mêmes registres, sous la même cloche.`,
