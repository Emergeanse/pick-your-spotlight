...
const EPILOGUE = {
  ...
  narrative: [
    ...
    `Il y a eu Verdun aussi, et le Fort de Vaux, et un homme qui en est revenu pour continuer, obstinément, à faire des enfants et à réparer des serrures. Il y a eu un quinté gagné en 1963, et un bar-PMU-bowling sur trois étages dont on a oublié le nom. Il y a eu Anne Knobloch aussi, une vie commune avant l'heure du divorce, et ses quatre enfants à elle qu'on n'a jamais comptés parmi les nôtres, mais qu'on n'oublie pas non plus. Et il y a eu Chantal, qui a porté tout ça — sans le savoir, comme on porte les choses, sans en avoir conscience — jusqu'à Tours, jusqu'à ses propres enfants, jusqu'à ce site qu'on écrit là, maintenant, pour elle et à cause d'elle.`,
