...
const CHAPTERS = [
  ...
  },
  {
    ...
    narrative: [
      ...
      "Il y a toi, <a class=\"person-link\" href=\"personne.html#christophe-olivier-billeux\">Christophe Olivier</a>, successeur de toutes ces générations, de tous ces paysages, de toutes ces histoires. Les morts t'ont précédé — ils ne savent plus rien de toi, mais toi tu sais quelque chose d'eux : <a class=\"person-link\" href=\"personne.html#jean-francois-billieux\">Jean-François</a> et <a class=\"person-link\" href=\"personne.html#marguerite-bregnard\">Marguerite</a> dont on ne retient que l'existence, quatorze générations, la mer traversée deux fois, les églises de Zommange et de Guébling, les vignes de Bouillonville, les collines d'Alger, Bordj Menaïel, les rues de Tours. Tu remontes le courant du Doubs jusqu'à Alle, comme on remonte vers des visages qu'on n'a jamais contemplés. Ils ne savaient pas qu'ils t'attendaient ; toi, tu sais qu'ils sont en toi — comme le rêve que font les morts à travers celui qui leur succède."
    ],
    cards: [
      {
        type: 'histoire',
