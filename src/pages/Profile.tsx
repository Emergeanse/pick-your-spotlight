  ...
  return (
    <div className="fixed inset-0 bg-background overflow-y-auto scrollbar-dark">
      <div
        ...
        style={{ backgroundImage: `url(${profileBackground})`, maskImage: "linear-gradient(to bottom, black 60%, transparent 100%)", WebkitMaskImage: "linear-gradient(to bottom, black 60%, transparent 100%)", opacity: 0.2 }}
      />
      <div
        className="fixed inset-0 pointer-events-none"
        style={{ background: "linear-gradient(to bottom, hsl(var(--background)/0.4) 0%, hsl(var(--background)/0.6) 40%, hsl(var(--background)/0.92) 75%, hsl(var(--background)) 100%)" }}
      />
