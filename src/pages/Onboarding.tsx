...
const Onboarding = () => {
  ...
  const handleFinish = async () => {
    ...
    try {
      ...
      // Extract genres from liked movies for profile
      const genres = new Set<string>();
      for (const movie of allSelected) {
        // genre_ids to names mapping
  ...
  return (
    <div className="fixed inset-0 bg-background flex flex-col">
      {/* Header */}
      <div className="flex-shrink-0 px-5 pt-[calc(1.5rem+env(safe-area-inset-top))] pb-4">
        <motion.div
