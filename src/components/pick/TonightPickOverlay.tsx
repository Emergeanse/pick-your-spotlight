...
const TonightPickOverlay = ({
  ...
  // Strip any leading name address generated by the LLM (e.g. "chris, " or "Christophe, ")
  // before prepending the correct first name. Pattern: a single word (letters only) followed by ", ".
