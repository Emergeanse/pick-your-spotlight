    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          <div className="fixed inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse at center, transparent 30%, hsl(var(--background) / 0.85) 100%)" }} />
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    {ou !== "a-distance" && (
                      <input
                        ...
                        className="w-full rounded-xl px-4 py-3 text-[13px] font-sans font-medium outline-none transition-colors"
                        style={{
                          position: "relative",
                          zIndex: 10,
