  ...
  return (
    <div className="space-y-3">
      {visibleGenres.length > 0 && (
        <div className={`flex flex-wrap gap-2${!collapsed ? " max-h-[108px] overflow-y-auto scrollbar-dark" : ""}`}>
      ...
      {visibleOrigins.length > 0 && (
        <div>
          ...
          <div className={`flex flex-wrap gap-2${!collapsed ? " max-h-[72px] overflow-y-auto scrollbar-dark" : ""}`}>
