        ...
        {options.map((opt, i) => {
          ...
          return (
            ...
            >
              ...
              />
              <div>
                <span className="font-serif text-xl md:text-2xl tracking-wide block">{opt.label}</span>
                <span className="text-muted-foreground text-sm mt-1 block font-sans">{opt.description}</span>
              </div>
            </motion.button>
          );
        })}
