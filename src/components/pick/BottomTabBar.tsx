import { Home, Bookmark, Clapperboard, User, Heart } from "lucide-react";
import { useNavigate, useLocation } from "react-router-dom";
import { motion } from "framer-motion";

export type TabId = "home" | "watchlist" | "friends" | "cinema" | "profile";
...
const tabs: { id: TabId; label: string; icon: typeof Home; path: string }[] = [
  ...
  { id: "friends", label: "Amis", icon: Heart, path: "/app/friends" },
